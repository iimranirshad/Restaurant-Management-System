...
namespace FoodCourtSystem
{
    ...
    {
        public static readonly string con_string = "Data Source = DESKTOP-1RQH46C\\SQLEXPRESS; Initial Catalog = TFC;Integrated Security=True";
